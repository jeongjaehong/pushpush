...
public class Prefs extends PreferenceActivity {
	...
	public static boolean getPlayback(Context context) {
		return PreferenceManager.getDefaultSharedPreferences(context)
				.getBoolean(OPT_PLAYBACK, OPT_PLAYBACK_DEF);
	}
	...
	public static void setMaxLevel(Context context, int level) {
		...
		case Common.EASY:
			PreferenceManager.getDefaultSharedPreferences(context).edit()
					.putInt(PREF_KEY0, level).commit();
		case Common.MEDIUM:
			PreferenceManager.getDefaultSharedPreferences(context).edit()
					.putInt(PREF_KEY1, level).commit();
		case Common.HARD:
			PreferenceManager.getDefaultSharedPreferences(context).edit()
					.putInt(PREF_KEY2, level).commit();
		}
	...
	public static int getIconsize(Context context) {
		String size = PreferenceManager.getDefaultSharedPreferences(context)
				.getString(OPT_ICONSIZE, OPT_ICONSIZE_DEF);
