    ...
    private void openNewGameDialog() {
        ...
        new AlertDialog.Builder(this).setTitle(R.string.new_game_title).setItems(R.array.difficulty, new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialoginterface, int difficulty) {
                ...
                Prefs.setDifficultly(StoreKeeperMain.this, difficulty);
                    ...
                    if (maxLevel >= clearLevel) {
                        switch (difficulty) {
                            case 0:
                                ...
                                //getPreferences(MODE_PRIVATE).edit().putInt(Common.PREF_KEY0, clearLevel).commit();
                                break;
                            case 1:
                                Prefs.setMaxLevel(this, clearLevel);
                                //getPreferences(MODE_PRIVATE).edit().putInt(Common.PREF_KEY1, clearLevel).commit();
                                break;
                            case 2:
                                Prefs.setMaxLevel(this, clearLevel);
                                //getPreferences(MODE_PRIVATE).edit().putInt(Common.PREF_KEY2, clearLevel).commit();
                                break;
                        }
                    }
